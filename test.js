 ...
 * @fileoverview Test suite for `nlcst-is-literal`.
 */
...
describe('isLiteral()', function () {
        ...
        it('should work on single word sentences', function () {
            assert.doesNotThrow(function () {
                process('Well? Ha! Funky', function (node, index, parent) {
                    equal(isLiteral(parent, index), false);
                });
            });
        });
    });
        ...
        [
            ...
            it('should detect `' + fixture + '`', function () {
                process(fixture, function (node, index, parent) {
                    equal(isLiteral(parent, index), index === 0);
                });
            });
        });
    });
        ...
        [
            ...
            it('should detect `' + fixture + '`', function () {
                process(fixture, function (node, index, parent) {
                    ...
                    equal(isLiteral(parent, index), index === seconLast);
                });
            });
        });
    });
    ...
    describe('Internal', function () {
        [
            ...
            it('should detect `' + fixture + '`', function () {
                process(fixture, function (node, index, parent) {
                    equal(isLiteral(parent, index), index === pos ? true : false);
                });
            });
        });
    });
